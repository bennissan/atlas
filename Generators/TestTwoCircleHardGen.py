...
with open('TestTwoCircleHardTraining.txt', 'w') as training, open('TestTwoCircleHardTestingAll.txt', 'w') as testingall, open('TestTwoCircleHardTestingSignal.txt', 'w') as testingsignal, open('TestTwoCircleHardTestingBackground.txt', 'w') as testingbackground:
