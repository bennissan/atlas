...
with open('8DHypersphereHardTraining.txt', 'w') as training, open('8DHypersphereHardTestingAll.txt', 'w') as testingall, open('8DHypersphereHardTestingSignal.txt', 'w') as testingsignal, open('8DHypersphereHardTestingBackground.txt', 'w') as testingbackground:
