...
with open('8DHypersphereHardTraining', 'w') as training, open('8DHypersphereHardTestingAll', 'w') as testingall, open('8DHypersphereHardTestingSignal', 'w') as testingsignal, open('8DHypersphereHardTestingBackground', 'w') as testingbackground:
