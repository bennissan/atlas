...
with open('8DHypersphereSoftTraining.txt', 'w') as training, open('8DHypersphereSoftTestingAll.txt', 'w') as testingall, open('8DHypersphereSoftTestingSignal.txt', 'w') as testingsignal, open('8DHypersphereSoftTestingBackground.txt', 'w') as testingbackground:
