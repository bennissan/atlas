...
with open('8DHypersphereSoftTraining', 'w') as training, open('8DHypersphereSoftTestingAll', 'w') as testingall, open('8DHypersphereSoftTestingSignal', 'w') as testingsignal, open('8DHypersphereSoftTestingBackground', 'w') as testingbackground:
