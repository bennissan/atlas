...
with open('PlaneSoftTraining', 'w') as training, open('PlaneSoftTestingAll', 'w') as testingall, open('PlaneSoftTestingSignal', 'w') as testingsignal, open('PlaneSoftTestingBackground', 'w') as testingbackground:
