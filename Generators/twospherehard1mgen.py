...
with open('TwoSphereHard1MTraining', 'w') as training, open('TwoSphereHard1MTestingAll', 'w') as testingall, open('TwoSphereHard1MTestingSignal', 'w') as testingsignal, open('TwoSphereHard1MTestingBackground', 'w') as testingbackground:
