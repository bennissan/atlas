...
for i in range(int(0.1 * size), int(0.2 * size)):
        while True:
                ...
                f3 = random.uniform(5, 9); f4 = random.uniform(5, 9)
                f5 = random.uniform(5, 9); f6 = random.uniform(5, 9)
                f7 = random.uniform(5, 9); f8 = random.uniform(5, 9)
                squaresum = (f1 - 7) ** 2 + (f2 - 7) ** 2 + (f3 - 7) ** 2 + (f4 - 7) ** 2 + (f5 - 7) ** 2 + (f6 - 7) ** 2 + (f7 - 7) ** 2 + (f8 - 7) ** 2
                if squaresum <= 4:
                        break
        table[i][0] = "+1"
        if squaresum > 2.75:
...
with open('8DTwoHypersphereSoftTraining.txt', 'w') as training, open('8DTwoHypersphereSoftTestingAll.txt', 'w') as testingall, open('8DTwoHypersphereSoftTestingSignal.txt', 'w') as testingsignal, open('8DTwoHypersphereSoftTestingBackground.txt', 'w') as testingbackground:
