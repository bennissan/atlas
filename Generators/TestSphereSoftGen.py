...
with open('TestSphereSoftTraining.txt', 'w') as training, open('TestSphereSoftTestingAll.txt', 'w') as testingall, open('TestSphereSoftTestingSignal.txt', 'w') as testingsignal, open('TestSphereSoftTestingBackground.txt', 'w') as testingbackground:
