...
with open('Test8DHypersphereHardTraining.txt', 'w') as training, open('Test8DHypersphereHardTestingAll.txt', 'w') as testingall, open('Test8DHypersphereHardTestingSignal.txt', 'w') as testingsignal, open('Test8DHypersphereHardTestingBackground.txt', 'w') as testingbackground:
