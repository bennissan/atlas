...
with open('Test8DHypersphereSoftTraining.txt', 'w') as training, open('Test8DHypersphereSoftTestingAll.txt', 'w') as testingall, open('Test8DHypersphereSoftTestingSignal.txt', 'w') as testingsignal, open('8DHypersphereSoftTestingBackground.txt', 'w') as testingbackground:
