...
with open('8DTwoHypersphereHardTraining', 'w') as training, open('8DTwoHypersphereHardTestingAll', 'w') as testingall, open('8DTwoHypersphereHardTestingSignal', 'w') as testingsignal, open('8DTwoHypersphereHardTestingBackground', 'w') as testingbackground:
