...
for i in range(int(0.1 * size), int(0.2 * size)):
        while True:
                ...
                if (f1 - 7) ** 2 + (f2 - 7) ** 2 + (f3 - 7) ** 2 + (f4 - 7) ** 2 + (f5 - 7) ** 2 + (f6 - 7) ** 2 + (f7 - 7) ** 2 + (f8 - 7) ** 2 <= 4:
                        break
        table[i][0] = "+1"
        table[i][1] = f1; table[i][2] = f2
        table[i][3] = f3; table[i][4] = f4
...
with open('8DTwoHypersphereHardTraining.txt', 'w') as training, open('8DTwoHypersphereHardTestingAll.txt', 'w') as testingall, open('8DTwoHypersphereHardTestingSignal.txt', 'w') as testingsignal, open('8DTwoHypersphereHardTestingBackground.txt', 'w') as testingbackground:
