...
with open('LinearSoftTraining', 'w') as training, open('LinearSoftTestingAll', 'w') as testingall, open('LinearSoftTestingSignal', 'w') as testingsignal, open('LinearSoftTestingBackground', 'w') as testingbackground:
