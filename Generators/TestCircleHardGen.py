...
with open('TestCircleHardTraining', 'w') as training, open('TestCircleHardTestingAll', 'w') as testingall, open('TestCircleHardTestingSignal', 'w') as testingsignal, open('CircleHardTestingBackground', 'w') as testingbackground:
