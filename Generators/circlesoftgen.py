...
with open('CircleSoftTraining', 'w') as training, open('CircleSoftTestingAll', 'w') as testingall, open('CircleSoftTestingSignal', 'w') as testingsignal, open('CircleSoftTestingBackground', 'w') as testingbackground:
