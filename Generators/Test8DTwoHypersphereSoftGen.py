...
with open('Test8DTwoHypersphereSoftTraining', 'w') as training, open('Test8DTwoHypersphereSoftTestingAll', 'w') as testingall, open('Test8DTwoHypersphereSoftTestingSignal', 'w') as testingsignal, open('Test8DTwoHypersphereSoftTestingBackground', 'w') as testingbackground:
