...
for i in range(int(0.1 * size)):
        while True:
                ...
                squaresum = (f1 - 0.5) ** 2 + (f2 - 0.5) ** 2 + (f3 - 0.5) ** 2 + (f4 - 0.5) ** 2 + (f5 - 0.5) ** 2 + (f6 - 0.5) ** 2 + (f7 - 0.5) ** 2 + (f8 - 0.5) ** 2
                if squaresum <= 1:
                        break
        table[i][0] = "+1"
        if squaresum > 0.75:
...
for i in range(int(0.15 * size), size):
        while True:
                ...
                squaresum1 = (f1 - 0.5) ** 2 + (f2 - 0.5) ** 2 + (f3 - 0.5) ** 2 + (f4 - 0.5) ** 2 + (f5 - 0.5) ** 2 + (f6 - 0.5) ** 2 + (f7 - 0.5) ** 2 + (f8 - 0.5) ** 2
                squaresum2 = (f1 + 0.5) ** 2 + (f2 + 0.5) ** 2 + (f3 + 0.5) ** 2 + (f4 + 0.5) ** 2 + (f5 + 0.5) ** 2 + (f6 + 0.5) ** 2 + (f7 + 0.5) ** 2 + (f8 + 0.5) ** 2
                if squaresum1 > 1 and squaresum2 > 1:
                        break
        table[i][0] = "-1"
        if squaresum1 < 1.25 or squaresum2 < 1.25:
        	if random.random() <= .15:
        		table[i][0] = "+1"
        table[i][1] = f1; table[i][2] = f2
        table[i][3] = f3; table[i][4] = f4
...
with open('Test8DTwoHypersphereSoftTraining.txt', 'w') as training, open('Test8DTwoHypersphereSoftTestingAll.txt', 'w') as testingall, open('Test8DTwoHypersphereSoftTestingSignal.txt', 'w') as testingsignal, open('Test8DTwoHypersphereSoftTestingBackground.txt', 'w') as testingbackground:
