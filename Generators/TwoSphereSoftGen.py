...
with open('TwoSphereSoftTraining.txt', 'w') as training, open('TwoSphereSoftTestingAll.txt', 'w') as testingall, open('TwoSphereSoftTestingSignal.txt', 'w') as testingsignal, open('TwoSphereSoftTestingBackground.txt', 'w') as testingbackground:
