...
do
        ...
        do
                sbatch -p largemem -c 4 --time=10080 --mem=50000 --output=BDT.%J.out --error=BDT.%J.err --mail-type=END,FAIL --mail-user=ben.nissan@tufts.edu RunBDT $Training $Testing".txt" Results/03-06/$Testing"0306.txt"
        done
done