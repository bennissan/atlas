...
do
        ...
        do
                sbatch -p largemem -c 4 --time=10080 --mem=50000 --output=BDS.%J.out --error=BDS.%J.err --mail-type=END,FAIL --mail-user=ben.nissan@tufts.edu RunBDS $Training $Testing".txt" Results/03-06/$Testing"0306.txt"
        done
done